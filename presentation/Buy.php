                        ...
                        function insertNewRow(nameTable)
                        {
                            ...
                            if (newRow === 0)
                            {
                                temp = '<tr id="tr' + newRow + '">' +
                                        ...
                                        '<td><input type="text" id="txtInvocenumber' + newRow + '" name="txtInvocenumber' + newRow + '" /></td>'+
                                        ...
                                        '<td><input type="text" id="txtBuyer' + newRow + '" name="txtBuyer' + newRow + '" /></td>'+
                                        '<td><input type="text" id="txtPayment' + newRow + '" name="txtPayment' + newRow + '" /></td>'+
                                        '</tr>';
                                $("#" + nameTable).html(temp);
                            } else
                            {
                                                    ...
                                                    if (data.toString().length > 0)
                                                    {
                                                        ...
                                                        for (var i = 0; i < array.length; i++)
                                                        {
                                                            ...
                                                            temp = temp + '<tr id="tr' + newRow + '">' +
                                                                    ...
                                                                    '<td><input type="text" id="txtInvocenumber' + newRow + '" name="txtInvocenumber' + newRow + '" value="' + person[5] + '"/></td>'+
                                                                    '<td><input type="text" id="txtProvide' + newRow + '" name="txtProvide' + newRow + '" value="' + person[6] + '"/></td>'+
                                                                    '<td><input type="text" id="txtPrice' + newRow + '" name="txtPrice' + newRow + '" value="' + person[7] + '"/></td>'+
                                                                    '<td><input type="text" id="txtBuyer' + newRow + '" name="txtBuyer' + newRow + '" value="' + person[8] + '"/></td>'+
                                                                    '<td><input type="text" id="txtPayment' + newRow + '" name="txtPayment' + newRow + '" value="' + person[9] + '"/></td>'+
